...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		if(Objects.nonNull(projectId)) {
			...
			throw new DbException("Project was not deleted");
		}
	}
	...
	private void selectProject() {
		...
		Integer projectId = getIntInput("Enter the project ID you wish to select");
	...
	private int getUserSelection() {
		printOperations();
		Integer input = getIntInput("Enter a menu selection (press Enter to quit)");
